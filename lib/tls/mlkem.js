...
// MlKem768Impl has sync methods; we instantiate it directly with `_api` wired to
// globalThis.crypto (available synchronously on Node 19+) so keygen stays off the
// microtask queue.
